...
String smartmeter_info = "1: Suncell 2: El-price this hour 3:El-expance";
...
void temp_choice() {
  switch (firstChoiceKey) {
    ...
    case '1': {
        ...
        scrollingText(bed_temp_Options);
        resettingKeys2();
      }
      break;
    ...
    case '2': {
        ...
        scrollingText(bath_temp_Options);
        resettingKeys2(activityKey, firstChoiceKey);
    ...
    case '3': {
        ...
        scrollingText(kitchen_temp_Options);
        resettingKeys2(activityKey, firstChoiceKey);
      }
      break;
...
void weather_choice() {
  switch (firstChoiceKey) {
    ...
    case '1': {
        ...
        scrollingText(outside_temp_Options);
        resettingKeys2(activityKey, firstChoiceKey);
      }
      break;
    ...
    case '2': {
        ...
        scrollingText(weather_humidity_Options);
        resettingKeys2(activityKey, firstChoiceKey);
    ...
    case '3': {
        ...
        scrollingText(weather_windspeed_Options);
        resettingKeys2(activityKey, firstChoiceKey);
      }
      break;
...
void suncell_choice () {
  switch (secondChoiceKey) {
    ...
    case '1': { //time
        ...
        scrollingText(suncell_hour_Options);
        resettingKeys3(activityKey, firstChoiceKey, secondChoiceKey);
    ...
    case '2': { //dag
        ...
        scrollingText(suncell_day_Options());
        resettingKeys3(activityKey, firstChoiceKey, secondChoiceKey);
    ...
    case '3': { //uke
        ...
        scrollingText(suncell_week_Options);
        resettingKeys3(activityKey, firstChoiceKey, secondChoiceKey);
      }
      break;
    ...
    case '4': { //mnd
        ...
        scrollingText(suncell_month_Options);
        resettingKeys3(activityKey, firstChoiceKey, secondChoiceKey);
      }
      break;
    ...
    case '5': { //aar
        ...
        scrollingText(suncell_year_Options);
        resettingKeys3(activityKey, firstChoiceKey, secondChoiceKey);
    ...
    default: {
        oneStaticLine(smartmeter_suncell);
...
void el_expense_choice () {
  switch (secondChoiceKey) {
    ...
    case '1': { //denne uken
        ...
        elexpense_week_Options = "The electricity expense this week is " + String(elexpense_week) + "MWh";
        scrollingText(elexpense_week_Options);
    ...
    case '2': { //mnd
        ...
        elexpense_month_Options = "The electricity expense this month is " + String(elexpense_month) + "MWh";

        scrollingText(elexpense_month_Options);
        resettingKeys3(activityKey, firstChoiceKey, secondChoiceKey);
    ...
    case '3': { //aar
        ...
        elexpense_year_Options = "The electricity expense this year is " + String(elexpense_year) + "MWh";

        scrollingText(elexpense_year_Options);
        resettingKeys3(activityKey, firstChoiceKey, secondChoiceKey);
      }
      break;

    default: {
        oneStaticLine(smartmeter_elexpense);
...
void smartmeter_choice () {
  switch (firstChoiceKey) {
    ...
    case '2': {
        ...
        scrollingText(eluse_price_hour_Options);
        resettingKeys2(activityKey, firstChoiceKey);
      }
      break;
    ...
    default: {
        oneStaticLine(smartmeter_hello);
...
void el_use () {
  ...
  switch (firstChoiceKey) {
    ...
    case '1': { //dag
        ...
        scrollingText(eluse_day_Options);
        resettingKeys2(activityKey, firstChoiceKey);
    ...
    case '2': { //uke
        ...
        scrollingText(eluse_week_Options);
        resettingKeys2(activityKey, firstChoiceKey);
    ...
    case '3': { //mnd
        ...
        scrollingText(eluse_month_Options);
        resettingKeys2(activityKey, firstChoiceKey);
