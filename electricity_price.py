...
#Initierer variabler og lister som skal logge verdier på strømregningen over lengre perioder 
previous_el_use = 0
el_bill_hourly = 0
el_bill_weekly = []
el_bill_monthly = []
...
while True: 
    # Henter strømprisen fra ENTSO-E
    prices = client.query_day_ahead_prices(country_code, start=start,end=end)
    #Prisen nå er da den siste og nyligste verdien i prices - series
    #Bruker indeksering for series og lagrer den nyligste prisen som et variabel
    ...
    #Beregner den endelige strømprisen i NOK. Prisen er for MWh og må deles på 1000 
    electricity_price_NOK = electricity_price_now * currency_exchange/1000
    ...
    el_bill_hourly = (el_use_hour) * electricity_price_NOK
    ...
    #Venter en time før vi gjentar hele while-loop
    time.sleep(3600)
