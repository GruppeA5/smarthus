...
//tilfeldige bokstaver og tall istedenfor de faktiske tokene
char gmailToken[] = "eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiI0OTA0In0.3xo_JoeqmyuYbro8lE4iPqe4pfnn2O_D0QtdWPO6-do0y"; //token for gmail-brukeren min,
char ntnuToken[] = "eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiI0OTcyIn0.PtuoX-smoeSiJjk9jrco-df-3TfEMkgN-mmdvpOxLCarTdr"; //ntnu-brukeren min
char outlookToken[] = "eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiI1OTAyIn0.GgOX1e1Y4Y844T1zcjynPpKk0E5vJ7S_SUuxi0"; //og outlook-brukeren min

//andre sine tokens
char czarnockajuliaToken[] = "eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiI1MDQ2In0.qs91VynV7MiI6sSqJKHFu4cfgH67dHrYI6OwSk5ySY0";
